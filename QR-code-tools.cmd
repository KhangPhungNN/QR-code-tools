...
set "libraries=qrcode opencv-python webbrowser validators Pillow distlib pyzbar"
...
if not [!temp_file!] == [] goto :skip_install_libraries
...
REM Mở file QR_code_tools.py trong thư mục Scripts tại đường dẫn hiện tại
start "" "%cd%\Scripts\QR_code_tools.py"